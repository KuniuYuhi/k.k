...
class BeholderEyeState_Attack : public IMobEnemyState
{
public:
	/// <summary>
	/// コンストラクタ
	...
	BeholderEyeState_Attack(BeholderEye* beholderEye, BeholderEyeStateContext* stateContest)
	{
		m_beholderEye = beholderEye;
		m_stateCotext = stateContest;
	}

	~BeholderEyeState_Attack();
